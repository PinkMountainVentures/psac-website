 ...
 */
function renderDepositHoldFailedEmail({ logoUrl, guestName, tripDateFormatted, updatePaymentLink }) {
  ...
  const bodyHtml = `
    <p>Hi ${greetingName},</p>
    <p>We tried to place the hold on your card on file for your gear this morning, but it didn't go through. Your trail day is ${dateText}, and we need this fixed by 11:00am Pacific today, just 2 hours from now, to get your gear scheduled for delivery.</p>
