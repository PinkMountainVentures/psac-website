...
'                <p style="margin:0 0 16px 0;">Most people who want this kind of morning never actually book it. You did.</p>\n' +
...
"                <p style=\"margin:0 0 16px 0;\">Here's what happens between now and your trail day: we'll follow up with a short Trip Prep step to confirm your delivery address and a few last details. Your gear kit, packed and ready, gets delivered to your door the evening before you go.</p>\n" +
'                <p style="margin:0; font-weight:600;">Nothing else for you to plan.</p>\n' +
'              </div>\n' +
'            </td>\n' +
'          </tr>\n' +
'          <tr>\n' +
