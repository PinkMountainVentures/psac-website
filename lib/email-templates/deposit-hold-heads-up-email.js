/* ============================================
   ...
   locked in psac-copy-drafts.md section 5, opening clause added per the
   2026-09-10 email/SMS Sinek/Godin/Miller audit (this was the flattest
   email in that audit -- pure administrivia with no acknowledgment that
   the reason for the hold is the trail day getting close). Action-needed template: not urgent in
