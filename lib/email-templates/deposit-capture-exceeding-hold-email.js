...
function buildBodyHtml(tokens) {
  return '<p>Thanks again for adventuring with Palm Springs Adventure Club. When we checked in your gear, ' + tokens.item + ' didn\'t come back with the rest of the kit.</p>' +
    '<p>Your $65 hold has been fully applied, and because full replacement runs $531, we\'ve charged an additional $' + tokens.additionalAmount + ' to the card on file to cover the difference, as agreed to at booking.</p>' +
 ...
 * @param {string|number} tokens.additionalAmount - the charge beyond the $65 hold
 */
