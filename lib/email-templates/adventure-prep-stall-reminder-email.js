...
// Exported (Sept 2026 SMS build) so lib/send-adventure-prep-stall-reminder-sms.js
// can build its own plain-text version of the exact same dynamic
// outstanding-tracks list, rather than re-deriving this logic separately
// and risking the two versions drifting apart.
module.exports = {
  renderStallReminderEmail,
  subjectFor: (variant) => (variant === 'action_needed' ? 'Action needed by 10pm tonight to keep your reservation' : 'Still a few things needed before your trail day'),
  outstandingTrackPhrases,
  joinNaturally,
};
