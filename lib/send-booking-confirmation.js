...
// booking.total is already the same server-consistent dollar figure computed
// from the locked TIERS pricing in api/create-payment-intent.js (booking fee
// + gear x count) — safe to display as-is, this is a receipt, not a new
// money-moving action.
 ...
 *   buildPayload() sends to /api/save-booking, plus bookingId merged in by
 *   the caller once the Apps Script response is known.
