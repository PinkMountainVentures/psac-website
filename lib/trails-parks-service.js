...
const TRAIL_WRITABLE_FIELDS = {
  ...
  // Golden Hour photo infrastructure (2026-09-09, db/2026-09-09_
  // add_trail_photo_slots.sql) -- same TRAIL_WRITABLE_FIELDS pattern,
  // four new single-photo slots alongside photoReferences above.
  photoHeroUrl: { column: 'photo_hero_url', type: 'text' },
  photoTrailheadUrl: { column: 'photo_trailhead_url', type: 'text' },
  photoOverlookUrl: { column: 'photo_overlook_url', type: 'text' },
  photoDetailUrl: { column: 'photo_detail_url', type: 'text' },
